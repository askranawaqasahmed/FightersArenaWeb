...
export const arenaHighlights = [
  ...
  { id: "arena-fury", eyebrow: "Find your place in the arena", title: "Every rivalry\nstarts with you.", summary: "Create your player profile, follow competitions, and make your next match count.", imageUrl: "/images/games/fatal-fury-cotw-hero.jpg", imageAlt: "Fatal Fury City of the Wolves gameplay", ctaLabel: "Join the arena", ctaUrl: "/login", status: "published" as const, order: 3 },
];
