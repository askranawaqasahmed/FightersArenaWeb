...
export default async function BoardBarPage({ params }: { params: Promise<{ number: string }> }) {
  ...
  return <BoardOverlay number={boardNumber} view="bar" initialState={initialState} />;
}
