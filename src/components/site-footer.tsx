...
export function SiteFooter() {
  return <footer className="footer"><div className="container">
    <div className="footer-grid">
      ...
      <div><div className="footer-title">Your arena</div><div className="footer-links"><Link href="/register">Join the community <ArrowUpRight size={12} /></Link><Link href="/dashboard">Player dashboard</Link><Link href="/admin">Organizer portal</Link></div></div>
